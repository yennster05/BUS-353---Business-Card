...
//@interface BusinessCardObject : NSObject
//@end

@interface BusinessCardObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BusinessCardObject class]])
		{
			for (NSString *key in [[(BusinessCardObject*)o modules] allKeys])
			{
