...
//Rare exceptions to indicate a bug in the _businesscard code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BusinessCard proxies.
 */
