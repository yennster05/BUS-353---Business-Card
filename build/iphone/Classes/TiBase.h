...
// in simulator we redefine to format for BusinessCard Developer console
...
{\
	NSString * exceptionName = [@"org.businesscard." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.businesscard";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBusinessCardNativeItemNone = -1, 
	UIBusinessCardNativeItemSpinner = -2,
	UIBusinessCardNativeItemProgressBar = -3,
	
	UIBusinessCardNativeItemSlider = -4,
	UIBusinessCardNativeItemSwitch = -5,
	UIBusinessCardNativeItemMultiButton = -6,
	UIBusinessCardNativeItemSegmented = -7,
	
	UIBusinessCardNativeItemTextView = -8,
	UIBusinessCardNativeItemTextField = -9,
	UIBusinessCardNativeItemSearchBar = -10,
	
	UIBusinessCardNativeItemPicker = -11,
	UIBusinessCardNativeItemDatePicker = -12,
	
	UIBusinessCardNativeItemInfoLight = -13,
	UIBusinessCardNativeItemInfoDark = -14,
	
	UIBusinessCardNativeItemDisclosure = -15,
	
	UIBusinessCardNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BusinessCard instances of
