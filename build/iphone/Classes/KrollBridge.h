...
@interface BusinessCardObject : KrollCoverageObject {
#else
@interface BusinessCardObject : KrollObject {
#endif
@private
...
extern NSString * BusinessCard$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BusinessCardObject *_businesscard;
    KrollObject* console;
	BOOL shutdown;
