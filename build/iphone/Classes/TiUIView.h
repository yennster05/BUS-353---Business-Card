...
/**
 Base class for all BusinessCard views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BusinessCard view hierarchy (such as wrapped iOS UIViews) was touched.
